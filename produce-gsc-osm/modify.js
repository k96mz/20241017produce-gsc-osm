...
const lut = {
  ...
  places_all_p: f => {
    ...
    if (
      f.properties.status === 'f' ||
      f.properties.ungsc_mission === 'UNMIK' ||
      f.properties.ungsc_mission === 'UNSMIL' ||
      f.properties.ungsc_mission === 'MINUSCA' ||
      f.properties.ungsc_mission === 'MONUSCO' ||
      f.properties.ungsc_mission === 'UNIFIL' ||
      f.properties.ungsc_mission === 'UNMISS' ||
      f.properties.ungsc_mission === 'UNAMID' ||
      f.properties.ungsc_mission === 'MINUJUSTH' ||
      f.properties.ungsc_ctry === 'TUN' ||
      f.properties.ungsc_ctry === 'LBN' ||
      f.properties.ungsc_ctry === 'SOM' ||
      f.properties.ungsc_ctry === 'SDN' ||
      f.properties.ungsc_ctry === 'xAB'
    ) {
      delete f;
    }
    return f;
